...
grails.config.locations = [ "classpath:logback.xml"]
...
logback = {
    appenders {
        ...
        rollingFile(
                ...
                rollingPolicy: new FixedWindowRollingPolicy(fileNamePattern: "testapp-%d{yyyy-MM-dd_HH-mm}.log")
        )
    }
